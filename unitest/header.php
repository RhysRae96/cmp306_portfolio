	...
	<div class="container-fluid no-padding"> <!-- containers are 1200px wide with default 15px padding -->
		<div class="row">
		  <div class="col-md-12">
			...
			<img class="img-fluid float-center img-responsive" src="./images/header.jpg" alt="Page header image" width="100%"/>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
	  ...
	  ?>
		  ...
		  <!-- <a href="./message_board.php" class="list-group-item list-group-item-action bg-light" style="color: black;">Announcements</a>
      <a href="./comments.php" class="list-group-item list-group-item-action bg-light" style="color: black;">Comments</a>
      <a href="./reviews.php" class="list-group-item list-group-item-action bg-light" style="color: black;">Reviews</a>
      <a href="./custupdate.php" class="list-group-item list-group-item-action bg-light" style="color: black;">Update Information</a> -->
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" style="color: black;" href="./message_board.php">Announcements</a>
            </li>
          </ul>
        </div>
      </nav>
